...
> Oversized agent backlog for `jtgsystems/CO-OP`. This file intentionally contains 500 candidate roadmap items so bots always have something to pick up.
...
## Basis
- Repository description: Working notes for jtgsystems/CO-OP.
- Detected stack: mixed or uncategorized source repo
- Profile guess: `software`
- Inferred stage: `foundation`
- Key paths: `discord-flowchart/`
- Read-first signals: `README.md`
...
- **Integrations, Jobs, And Growth Surface**: integration code, background jobs, and scale-oriented surfaces
- **Testing, Verification, And CI**: tests, linting, smoke checks, and CI workflows
- **Documentation, Onboarding, And Handoffs**: `README.md`, `AGENTS.md`
- **Tooling, Scripts, And Maintenance Automation**: scripts, config, repo automation, and maintenance tooling
- **Security, Reliability, And Operational Safety**: security-sensitive files, ops surfaces, and reliability controls
...
Scope: integration code, background jobs, and scale-oriented surfaces
...
Scope: tests, linting, smoke checks, and CI workflows
...
Scope: scripts, config, repo automation, and maintenance tooling
...
Scope: security-sensitive files, ops surfaces, and reliability controls
